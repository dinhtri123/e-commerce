              ...
              <div className="flex gap-x-3">
                <div className="flex gap-x-1 items-center text-white">
                  <img
                    src="/login.png"
                    alt=""
                    className="w-5 h-10 rounded-full object-cover"
                  />
                  <p>{user.displayName}</p>
                </div>
                <NavLink to={"/signup"} onClick={handleSignOut} className='rounded-lg bg-error text-white'>
                  <span>Logout</span>
                  <img src="/logout.png" alt="" className="w-10 h-10 object-cover" />
                </NavLink>
              </div>
            ) : (
