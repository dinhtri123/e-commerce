  ...
  return (
    <div className="w-full bg-primary bg-opacity-5 z-10">
      <div className="container p-10 pb-0 flex flex-col gap-y-5">
        <div className="text-center text-dark mb-5 bg-primary bg-opacity-5 p-8 sm:p-10 md:w-[80%] w-[100%] mx-auto rounded-[20px] letter">
          <h3 className="lg:text-[40px] md:text-[35px] text-[30px] font-bold mb-5 isolate">Newsletter</h3>
          <p className="text-[14px] mb-10 isolate">
            Enter your email address for our mailing list to keep your self
            update
          </p>
          <div className="max-w-[700px] w-full h-[50px] rounded-[50px] bg-text3 bg-opacity-5 flex px-8 mx-auto items-center isolate">
            <input
              type="text"
