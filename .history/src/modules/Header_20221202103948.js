        ...
        <div className="container mx-auto px-5 max-sm:px-3 py-3 md:grid-cols-3 flex items-center justify-between w-full h-[70px] max-sm:bg-white max-sm:shadow-lg">
          ...
          <div className="flex items-center justify-end cursor-pointer gap-x-5">
            ...
            <div className="md:hidden">
              ...
              />
              {showMenu && (
                <div className="z-50 isolute fixed right-0 top-0 w-[50%] h-full bg-white shadow-lg py-[100px] px-10">
                  <img
                    src="/cancel.png"
                    alt=""
                  ...
                  <div className="flex flex-col gap-5 item-center">
                    {menuLinks.map((item) => (
                      <NavLink key={item.title} to='' className="font-medium">
                        {item.title}
                      </NavLink>
                    ))}
                    <button
                      to={() => navigate("/login")}
                      className="w-full h-10 rounded-md bg-primary text-white"
                    >
                      Login
                    </button>
                  </div>
