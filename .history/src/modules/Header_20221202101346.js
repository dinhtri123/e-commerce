  ...
  return (
    <div className="relative">
      <div className="fixed top-0 left-0 w-full z-10 isolute header bg-white">
        <div className="container mx-auto px-5 max-sm:px-3 max-sm:py-1 md:grid-cols-3 flex items-center justify-between w-full sm:h-[70px] h-[60px] max-sm:bg-white max-sm:shadow-lg">
