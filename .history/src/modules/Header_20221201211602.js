  ...
  return (
    ...
    {profile && (
      <div className="z-50 isolute fixed top-[75px] right-10 bg-white text-black rounded-lg p-5 flex flex-col gap-5">
        <p className="flex gap-2"><span>Username:</span> <span className="text-medium">{user.displayName}</span></p>
        <p className="flex gap-2"><span>Email:</span><span className="text-medium">{user.email}</span></p>
        <NavLink
          to={"/signup"}
