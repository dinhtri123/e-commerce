      ...
      <div className="container w-full h-full px-5 py-12 relative flex justify-center items-center">
        ...
        <div className="login max-w-[500px] w-full h-auto mx-auto p-10 flex flex-col items-center relative shadow-2xl rounded-lg">
          ...
          >
            ...
            ></Input> */}
            <button
              className={`w-full h-[45px] text-white bg-primary rounded-md font-semibold`}
            >
              {loading ? (
                <p className=" mx-auto w-[30px] h-10 rounded-full border-4 border-white border-t-transparent border-b-transparent animate-spin"></p>
              ) : (
                "Create an Account"
              )}
            </button>
