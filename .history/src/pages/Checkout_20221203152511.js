              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-5 items-center">
                  <div className="flex items-center justify-center w-[160px] h-[50px] font-medium text-text3 text-[15px] gap-x-2 border rounded-xl">
                    <ion-icon name="rocket-outline" className="text-lg"></ion-icon>
                    <span>Same Day</span>
                  </div>
                  <div className="flex items-center justify-center w-[160px] h-[50px] font-medium text-text3 text-[15px] gap-x-2 border rounded-xl">
                  <ion-icon name="bicycle-outline" className="text-lg"></ion-icon>
                    <span>Express</span>
                  </div>
                  <div className="flex items-center justify-center w-[160px] h-[50px] font-medium text-text3 text-[15px] gap-x-2 border rounded-xl">
                  <ion-icon name="walk-outline" className="text-lg"></ion-icon>
                    <span>Normal</span>
                  </div>
                </div>
              </div>
