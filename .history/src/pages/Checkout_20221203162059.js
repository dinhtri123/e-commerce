...
const Checkout = () => {
  ...
  for (let i = 0; i < deliveryItem.length; i++) {
    deliveryItem[i].addEventListener("click", function (e) {
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                {delivery.map((item,in) => {})}
                  <div
                    className={`flex items-center justify-center w-[160px] h-[50px] font-medium text-text3 text-[15px] gap-x-2 border rounded-xl cursor-pointer delivery-item`}
                  >
                    <ion-icon
                      name="rocket-outline"
                      style={{ width: "20px", height: "20px" }}
                  ...
                  <div className="flex items-center justify-center w-[160px] h-[50px] font-medium text-text3 text-[15px] gap-x-2 border rounded-xl cursor-pointer delivery-item">
                    <ion-icon
                      name="bicycle-outline"
                      style={{ width: "20px", height: "20px" }}
                    ></ion-icon>
