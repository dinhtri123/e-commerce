...
const SignUp = () => {
  ...
  return (
    <div className="login-box w-full h-full bg-primary bg-opacity-10">
      <div className="container w-full h-screen px-5 py-12 relative flex flex-col justify-center items-center">
        <NavLink
          to="/"
          className={
            "w-full h-14"
