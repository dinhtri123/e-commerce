...
const schema = yup.object({
  ...
  password: yup.string().min(8, "Password must be 8 characters").required("This field is required"),
});
const Login = () => {
  const {
    control,
      ...
      <div className="container w-full h-screen p-5 relative flex justify-center items-center">
        ...
        <div className="login max-w-[500px] w-full mx-auto p-10 flex flex-col items-center relative shadow-2xl rounded-lg">
          ...
          >
            ...
            ></Input>
            <InputPassword name="password" error={errors.password?.message} control={control}></InputPassword>
