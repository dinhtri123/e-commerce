      ...
      <div className="container p-5">
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          ...
          <div className="p-5">
            ...
            <div className='w-full h-[220px] rounded-lg bg-primary bg-opacity-5 flex items-center justify-center mb-5'>
              <img src="/Mastercard-logo.png" alt="" className="w-[80%] h-[80%] object-fill"/>
            </div>
            <div className="flex flex-col gap-5 bg-primary rounded-lg text-white p-5">
