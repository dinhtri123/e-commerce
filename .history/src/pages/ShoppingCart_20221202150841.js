      ...
      <div className="container p-5">
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="w-full md:grid grid-cols-[2fr,1fr] flex flex-col gap-10">
            ...
            {totalAmount > 0 && (
              <div className="bg-text3 bg-opacity-5 rounded-lg p-5">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <button className="w-full py-4 bg-primary rounded-md text-white hover:bg-error transition-all" onClick={handleCheckout}>Checkout
                  </button>
                </div>
              </div>
            )}
