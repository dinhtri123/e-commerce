      ...
      <div className="container p-5">
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          ...
          <div className="p-5">
            ...
            <div className='w-full h-[220px] rounded-lg bg-blueDark bg-opacity-100 flex items-center justify-center mb-5'>
              <img src="https://taichinh.online/wp-content/uploads/2017/02/the-mastercard.png" alt="" className="w-[80%] h-[80%] object-fill"/>
            </div>
