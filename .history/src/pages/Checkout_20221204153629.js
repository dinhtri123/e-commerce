        ...
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          ...
          <div className="bg-primary bg-opacity-5 rounded-lg p-5  w-full h-fit">
            ...
            <div className="flex flex-col gap-5 text-black rounded-lg p-5">
                <p className="text-[40px] text-center">{totalQty} items</p>
              ...
              <button className="mt-5 w-full bg-primary text-black h-[45px] flex items-center justify-center font-medium rounded-lg">
                Place an order
              </button>
            </div>
          </div>
