  ...
  return (
    <div className="w-full h-screen bg-primary bg-opacity-10">
      <div className="container w-full h-screen p-5 relative flex justify-center items-center">
        <NavLink to="/" className={"absolute top-10 left-10 w-[50px] h-[50px]"}>
          <img src="/qora.png" alt="" className="w-full h-full" />
        </NavLink>
        <div className="login max-w-[500px] sm:w-full w-[100%] mx-auto p-10 flex flex-col items-center relative shadow-2xl rounded-lg">
