          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex justify-start wrap sm:gap-5 gap-2 items-center max-h-0 overflow-hidden delivery opacity-0">
                  {delivery.map((item, index) => (
                    <div
                      key={index}
                      className={`flex items-center justify-center min-w-[160px] h-[50px] font-medium text-[15px] gap-x-1 border rounded-xl cursor-pointer delivery-item ${
          ...
          <div className="bg-primary bg-opacity-5 rounded-lg p-5 lg:w-full md:w-[60%] sm:w-[80%] w-full h-fit">
            ...
            <div className="w-full h-[220px] rounded-lg flex items-center justify-center mb-5">
              <img
                ...
                alt=""
                className="w-[100%] h-[90%] object-fill"
              />
            </div>
