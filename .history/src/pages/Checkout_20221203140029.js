          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="border rounded-lg px-5 py-3 flex items-center justify-between cursor-pointer" onClick={show}>
                ...
                <form
                  className="grid grid-cols-2 gap-5 text-sm p-5 border rounded-lg bg-white"
                  autoComplete="off"
                >
                  <Input
                    text={"Name*"}
