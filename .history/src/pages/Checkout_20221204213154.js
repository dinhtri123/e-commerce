  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="my-[80px]">
      <div className="container p-5">
        <div className="mt-10 grid lg:grid-cols-[2fr,1fr] grid-cols-1 gap-10">
          <div>
          ...
          <div className="bg-primary bg-opacity-5 rounded-lg p-5 lg:w-full md:w-[60%] max-x-auto h-fit">
