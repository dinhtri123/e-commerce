...
const Checkout = () => {
  ...
  const showInfo = () => {
    ...
    info.classList.toggle("form_infor")
  }
  return (
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <form
                  className="grid grid-cols-2 gap-5 text-sm rounded-lg bg-white p-5 border scale-y-0 items-start overflow-hidden form-info"
                  autoComplete="off"
                >
                  <Input
                    text={"Name*"}
