          ...
          <div className="w-full md:grid grid-cols-[2fr,1fr] flex flex-col gap-10">
            ...
            {totalAmount > 0 && (
              <div className="bg-text3 bg-opacity-5 rounded-lg p-5 pb-10 w-full h-fit">
                ...
                <div>
                  <h3>Information about shipping fees</h3>
                  <div className="flex flex-col gap-3">
                    <p className="flex gap-x-2">{`Subtotal < $1000 : <span className=">Free Shipping</span>`}</p>
                    <p className="flex gap-x-2">{`Subtotal < $5000 : <span className=">Fee $100</span>`}</p>
                    <p className="flex gap-x-2">{` Subtotal > $5000 : <span className=">Fee $200</span>`}</p>
                  </div>
                </div>
                <p className="mb-10 text-text3">
