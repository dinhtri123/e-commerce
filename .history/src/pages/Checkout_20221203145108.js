          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="w-full h-full border rounded-lg px-5 py-3 flex items-center justify-between cursor-pointer" onClick={handleCollapse}>
                ...
                <form
                  className="grid grid-cols-2 gap-5 text-sm rounded-lg bg-white max-h-0 opacity-0 items-start overflow-hidden accordion"
                  autoComplete="off"
                >
                  <Input
                    text={"Name*"}
