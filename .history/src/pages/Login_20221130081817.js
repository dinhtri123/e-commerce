...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen">
      <div className="container w-full h-screen p-5 relative flex justify-center items-center z-100 isolute">
        ...
        <div className="login max-w-[500px] w-full mx-auto p-10 flex flex-col items-center relative shadow-lg">
          ...
          <div className="absolute -left-[250px] -bottom-[150px] w-[450px] h-[450px]">
            <svg
              id="10015.io"
              viewBox="0 0 480 480"
