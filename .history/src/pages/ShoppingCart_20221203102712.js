              ...
              <div className="bg-text3 bg-opacity-5 rounded-lg p-5 pb-10 w-full h-fit">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    <p className="flex gap-x-2">{`Subtotal < $1000 : <span class>Free Shipping</span>`}</p>
                    <p className="flex gap-x-2">{`Subtotal < $5000 : <span class>Fee $100</span>`}</p>
                    <p className="flex gap-x-2">{` Subtotal > $5000 : <span class>Fee $200</span>`}</p>
                  </div>
                </div>
