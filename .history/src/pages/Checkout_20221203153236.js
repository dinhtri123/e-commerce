          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-5 items-center p-5 accordion">
                  <div className="flex items-center justify-center w-[160px] h-[50px] max-h-0 font-medium text-text3 text-[15px] gap-x-2 border rounded-xl">
                    <ion-icon
                      name="rocket-outline"
