          ...
          <div className="w-full md:grid grid-cols-[2fr,1fr] flex flex-col gap-10">
            ...
            {totalAmount > 0 && (
              <div className="bg-text3 bg-opacity-5 rounded-lg p-5 pb-10 w-full h-fit">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-3">Information about shipping fees</h3>
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="flex gap-x-2">
                      {`Subtotal < $5000 : `}
                      <span className="font-medium text-primary">Fee $100</span>
                    </p>
                    <p className="flex gap-x-2">
                      {` Subtotal > $5000 : `}
                      <span className="font-medium text-primary">Fee $200</span>
                    </p>
                  </div>
                </div>
