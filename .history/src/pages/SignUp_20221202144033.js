...
const SignUp = () => {
  ...
  return (
    <div className="login-box w-full h-[100vmin] bg-primary bg-opacity-10">
      <div className="container w-full h-full px-5 py-12 relative flex flex-col justify-center items-center">
        <NavLink
          to="/"
          className={
            "w-full h-14"
