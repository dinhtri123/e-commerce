      ...
      <div className="container p-5">
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          ...
          <div className="p-5">
            ...
            <div className='w-full h-[280px] rounded-lg bg-primary bg-opacity-5 flex items-center justify-center'>
              <img src="/Mastercard-logo.png" alt="" className="w-[60%] h-[70%] object-fill"/>
            </div>
