...
const schema = yup.object({
  ...
  delivery: yup.mixed().oneOf(['Same Day', 'Express', 'Normal'], "Please choose 1 of 3 payment methods")
});
const Checkout = () => {
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-5 items-center max-h-0 overflow-hidden delivery opacity-0" {...register("delivery")}>
