...
const schema = yup.object({
  ...
  phone: yup
    .string().required("Please enter your phone number")
...
const Checkout = () => {
  ...
  const onSubmit = (values) => {
    ...
    if(values.name === "" && values.email === "" && values.phone === "" && values.street === "" && values.city === ""){
      toast.error("You must fill in all information in Contact Information")
    }
  };
  const priceShipping = () => {
    let price;
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="my-[80px]">
      <div className="container p-5">
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          <div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-3">
                ...
                <div className="info border max-h-[300px] overflow-hidden bg-white rounded-lg">
                  <div
          ...
          <div className="bg-primary bg-opacity-5 rounded-lg p-5  w-full h-fit">
            <h3 className="text-[30px] mb-5 font-semibold text-center">Order Summary</h3>
            <div className='w-full h-[220px] rounded-lg flex items-center justify-center mb-5'>
              <img src="https://taichinh.online/wp-content/uploads/2017/02/the-mastercard.png" alt="" className="w-[100%] h-[90%] object-fill"/>
            </div>
            <div className="flex flex-col gap-5 text-black rounded-lg p-5">
              ...
              <div className="flex gap-x-2 justify-between">
                ...
                <span className="text-dark font-semibold">${priceShipping()}</span>
              </div>
              <div className="flex gap-x-2 justify-between">
                <p className="text-text3 font-medium">Delivery: </p>
                <span className="text-dark font-semibold">${priceDelivery()}</span>
              </div>
              ...
              <div className="flex gap-x-2 justify-between text-lg">
                ...
                <span className="text-dark font-semibold text-xl">${totalAmount + priceDelivery() + priceShipping()}</span>
              </div>
