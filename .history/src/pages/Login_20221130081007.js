          ...
          <form autoComplete="off" className="flex flex-col gap-5 w-[90%]">
            ...
            <div className="flex flex-col gap-2 text-sm font-medium">
              ...
              <div className="w-full border rounded-md px-5 py-3 pr-12 relative">
                ...
                />
                {password ? (
                  <IconEye className={`absolute top-2/4 right-5 -translate-y-2/4 cursor-pointer`}
                    onClick={hiddenPassword}></IconEye>
                ) : (
                  <IconEyeSlash
            ...
            <button className="w-full h-[45px] text-white bg-primary rounded-md font-semibold">Sign in</button>
          </form>
        </div>
        <div>
        <svg id="10015.io" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" >
	<path fill="#474bff" d="M364,309Q320,378,225.5,403.5Q131,429,105.5,334.5Q80,240,106,147Q132,54,222.5,83.5Q313,113,360.5,176.5Q408,240,364,309Z" />
</svg>
        </div>
      </div>
    </div>
