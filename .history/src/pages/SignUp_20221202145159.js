...
const SignUp = () => {
  ...
  return (
    <div className="login-box w-full h-screen bg-primary bg-opacity-10">
      <div className="container w-full h-full px-5 sm:py-12 relative flex flex-col justify-center items-center">
        <NavLink
          to="/"
          className={
        ...
        <div className="login max-w-[500px] w-full h-auto mx-auto sm:p-10 p-5 flex flex-col items-center relative shadow-2xl rounded-lg my-14">
