            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-5 items-center">
                  <div className="flex items-center justify-center w-[120px] h-[60px] gap-x-2 border rounded-xl hover:bg-primary text-text3 hover:text-dark transition-all">
                    <img src="/pickup-truck.gif" alt="" className="w-10 h-10"/>
                    <span>Same Day</span>
                  </div>
                  <div className="flex gap-x-2 border rounded-xl hover:bg-primary text-text3 hover:text-dark transition-all">
                    <img src="/pickup-truck.gif" alt="" className="w-10 h-10"/>
                    <span>Same Day</span>
                  </div>
                  <div className="flex gap-x-2 border rounded-xl hover:bg-primary text-text3 hover:text-dark transition-all">
