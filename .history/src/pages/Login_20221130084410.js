  ...
  return (
    <div className="w-full h-screen">
      <div className="container w-full h-screen p-5 relative flex justify-center items-center">
        ...
        <div className="login max-w-[500px] w-full mx-auto p-10 flex flex-col items-center relative shadow-lg rounded-lg">
          ...
          <form autoComplete="off" className="flex flex-col gap-5 w-[90%] z-10">
