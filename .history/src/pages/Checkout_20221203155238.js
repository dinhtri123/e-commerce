        ...
        <div className="mt-10 grid grid-cols-[2fr,1fr] gap-x-10">
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                <div className="border rounded-lg px-5 py-3 flex items-center justify-between cursor-pointer" onClick={handleCollapsePayment}>
                  <h3 className="text-lg font-medium">3. Payment Methob</h3>
                  <span className="transition-all">
                    {changeIcon3 ? <IconDown></IconDown> : <IconUp></IconUp>}
                  </span>
                </div>
                <p className="p-5 payment over">Customers will make payment after receiving the goods</p>
              </div>
            </div>
          </div>
          <div>
