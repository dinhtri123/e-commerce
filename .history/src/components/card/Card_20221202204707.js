...
const cartItems = useSelector()
  ...
  return (
    <div className="overflow-hidden transition-all card w-full h-full rounded-lg">
      ...
      <div className="flex flex-col p-5 justify-between gap-y-4 card-content">
        ...
        <h3 className="font-semibold w-full h-[2rem]">{title}</h3>
        <div className="flex justify-between items-center gap-x-5">
          <p className="font-semibold text-error">${price}</p>
